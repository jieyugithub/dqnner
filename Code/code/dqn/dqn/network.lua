...
function create_network(args)
    ...
    net:add(nn.Linear(args.state_dim, args.n_hid1))
    net:add(args.nl())                                  ---lutm: non-linear function
    net:add(nn.Linear(args.n_hid1, args.n_hid2))
    net:add(args.nl())
    ...
    seq1 = nn.Linear(args.n_hid2, args.n_actions)
    seq2 = nn.Linear(args.n_hid2, args.n_objects)
